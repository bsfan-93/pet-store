...
const features = ref([
  { 
    id: 'camera', 
    title: 'Scout Smart Camera',
    subtitle: 'Goodbye worries. Hello Scout.',
    description: '',
    imageSrc: '/images/feature-camera.jpg',
    isNew: true,
    showButtons: true,
  },
  { 
    id: 'granary', 
    title: 'Granary Series',
    subtitle: 'Award-winning automatic feeders',
    description: '',
    imageSrc: '/images/feature-feeder.jpg',
    isNew: false, // bestSeller: true, (此字段暂未在模板使用)
    showButtons: true,
  },
  { 
    id: 'rfid', 
    title: 'One RFID Feeder',
    subtitle: 'Feeding made personal for multiple pet families.',
    description: '',
    imageSrc: '/images/feature-rfid-feeder.jpg', // 建议为这个特性使用一张不同的图片
    isNew: false,
    showButtons: true,
  },
  { 
    id: 'fountain', 
    title: 'Dockstream Cordless Fountain',
    subtitle: 'Fresh, flowing water to encourage hydration.',
    description: '',
    imageSrc: '/images/feature-fountain.jpg',
    isNew: false,
    showButtons: true,
  },
]);
...
.buy-now-btn {
  padding: 12px 24px;
  background-color: var(--accent-color, #6a994e);
  color: white;
  border: none;
  border-radius: 4px;
  cursor: pointer;
